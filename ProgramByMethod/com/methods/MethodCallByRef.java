...
public class MethodCallByRef {
  ...
  public static void main(String[] args) {
    ...
    MethodCallByRef c = new MethodCallByRef();
    ...
    MethodCallByRef.m2(a, ep1); // We can pass different Employee type reference variable. Reference Variable name is not important but Employee type is important. So, don't confuse in ep and ep1.

    // OR
    MethodCallByRef.m2(new Admin(), new Employee());
  }
}
